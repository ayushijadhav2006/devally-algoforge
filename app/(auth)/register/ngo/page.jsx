      ...
      <form className="my-8" onSubmit={registerHandle}>
        ...
        <LabelInputContainer className="mb-4">
          ...
          {invalidInputs.includes("registrationNumber") && (
            <p className="text-red-500 text-sm">
              Please enter a valid registration number (e.g., S/12345/UP/2023,
              123/Trust/2022, U12345DL2023NPL012345).
            </p>
          )}
        </LabelInputContainer>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-30 flex justify-center items-center p-4">
            <div className="bg-white p-6 rounded-lg max-w-md">
              ...
              <p className="mt-2 text-sm">
                Smile-Share agrees not to share any confidential data of your
                NGO with other NGOs or third parties. Any breach of this
                agreement gives the NGO the right to take legal action.
              </p>
              <button
