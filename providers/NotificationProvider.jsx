...
export function NotificationProvider({ children }) {
  ...
  return (
    <NotificationContext.Provider value={value}>
      ...
      {/* Badge Notification */}
      {showBadges && (
        <BadgeNotification badges={badges} onClose={closeBadgeNotification} />
      )}
      ...
      <AnimatePresence>
        {levelUp && (
          <motion.div
            ...
            className="fixed top-5 left-1/2 transform -translate-x-1/2 z-50 max-w-sm bg-white rounded-xl shadow-xl overflow-hidden"
          >
      ...
      <AnimatePresence>
        {points && (
          <motion.div
            ...
            exit={{ opacity: 0, x: 50 }}
            className="fixed bottom-5 right-5 z-50 bg-white rounded-lg shadow-lg py-2 px-4 flex items-center gap-2"
          >
